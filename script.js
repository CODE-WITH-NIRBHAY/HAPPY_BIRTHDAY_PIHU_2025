...
modal.find("p").html("Now, let's decorate it the same way you decorate everyone's life with your smile.")
...
setTimeout(()=>{$(".flame").addClass("in")},800)
...
setTimeout(()=>{$(this).show().css('animation-delay',`${i*.2}s`)},500)
})
},2000)
})
})

$("#replay").on('click',function(){location.reload()})
